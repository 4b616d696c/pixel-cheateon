...
import com.pixelcheateon.actors.buffs.MagicalSight;
import com.pixelcheateon.actors.buffs.MindVision;
import com.pixelcheateon.actors.buffs.RevealedArea;
...
import com.pixelcheateon.actors.mobs.npcs.Blacksmith;
import com.pixelcheateon.actors.mobs.npcs.Ghost;
import com.pixelcheateon.actors.mobs.npcs.Imp;
import com.pixelcheateon.actors.mobs.npcs.Wandmaker;
...
import com.pixelcheateon.levels.CavesLevel;
import com.pixelcheateon.levels.CityLevel;
import com.pixelcheateon.levels.DeadEndLevel;
import com.pixelcheateon.levels.HallsLevel;
import com.pixelcheateon.levels.LastLevel;
import com.pixelcheateon.levels.Level;
import com.pixelcheateon.levels.CavesBossLevel;
import com.pixelcheateon.levels.CityBossLevel;
import com.pixelcheateon.levels.HallsBossLevel;
import com.pixelcheateon.levels.PrisonBossLevel;
import com.pixelcheateon.levels.PrisonLevel;
import com.pixelcheateon.levels.RegularLevel;
import com.pixelcheateon.levels.SewerBossLevel;
import com.pixelcheateon.levels.SewerLevel;
...
public class Dungeon {
	...
	public static void init() {
		...
		challenges = PCSettings.challenges();
		mobsToChampion = -1;

		if (daily) {
			//Ensures that daily seeds are not in the range of user-enterable seeds
			seed = PCSettings.lastDaily() + DungeonSeed.TOTAL_SEEDS;
			DateFormat format = new SimpleDateFormat("yyyy-MM-dd", Locale.ROOT);
			format.setTimeZone(TimeZone.getTimeZone("UTC"));
			customSeedText = format.format(new Date(PCSettings.lastDaily()));
		} else if (!PCSettings.customSeed().isEmpty()){
			customSeedText = PCSettings.customSeed();
