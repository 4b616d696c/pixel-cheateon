...
import com.pixelcheateon.actors.buffs.AscensionChallenge;
import com.pixelcheateon.actors.buffs.ChampionEnemy;
import com.pixelcheateon.actors.hero.Hero;
import com.pixelcheateon.actors.hero.Talent;
import com.pixelcheateon.actors.mobs.DemonSpawner;
import com.pixelcheateon.actors.mobs.Ghoul;
import com.pixelcheateon.actors.mobs.Mob;
import com.pixelcheateon.actors.mobs.Snake;
import com.pixelcheateon.effects.BannerSprites;
import com.pixelcheateon.effects.BlobEmitter;
import com.pixelcheateon.effects.EmoIcon;
import com.pixelcheateon.effects.Flare;
import com.pixelcheateon.effects.FloatingText;
import com.pixelcheateon.effects.Ripple;
import com.pixelcheateon.effects.SpellSprite;
import com.pixelcheateon.items.Ankh;
...
import com.pixelcheateon.items.journal.Guidebook;
import com.pixelcheateon.items.potions.Potion;
import com.pixelcheateon.items.scrolls.ScrollOfTeleportation;
import com.pixelcheateon.journal.Document;
import com.pixelcheateon.journal.Journal;
import com.pixelcheateon.levels.Level;
import com.pixelcheateon.levels.RegularLevel;
import com.pixelcheateon.levels.Terrain;
import com.pixelcheateon.levels.rooms.Room;
import com.pixelcheateon.levels.rooms.secret.SecretRoom;
import com.pixelcheateon.levels.traps.Trap;
...
import com.pixelcheateon.sprites.DiscardedItemSprite;
import com.pixelcheateon.sprites.HeroSprite;
import com.pixelcheateon.sprites.ItemSprite;
import com.pixelcheateon.tiles.CustomTilemap;
import com.pixelcheateon.tiles.DungeonTerrainTilemap;
import com.pixelcheateon.tiles.DungeonTileSheet;
import com.pixelcheateon.tiles.DungeonTilemap;
import com.pixelcheateon.tiles.DungeonWallsTilemap;
import com.pixelcheateon.tiles.FogOfWar;
import com.pixelcheateon.tiles.GridTileMap;
import com.pixelcheateon.tiles.RaisedTerrainTilemap;
import com.pixelcheateon.tiles.TerrainFeaturesTilemap;
import com.pixelcheateon.tiles.WallBlockingTilemap;
import com.pixelcheateon.ui.ActionIndicator;
import com.pixelcheateon.ui.AttackIndicator;
import com.pixelcheateon.ui.Banner;
import com.pixelcheateon.ui.BossHealthBar;
import com.pixelcheateon.ui.CharHealthIndicator;
import com.pixelcheateon.ui.GameLog;
import com.pixelcheateon.ui.Icons;
import com.pixelcheateon.ui.InventoryPane;
import com.pixelcheateon.ui.LootIndicator;
import com.pixelcheateon.ui.MenuPane;
import com.pixelcheateon.ui.QuickSlotButton;
import com.pixelcheateon.ui.ResumeIndicator;
import com.pixelcheateon.ui.RightClickMenu;
import com.pixelcheateon.ui.StatusPane;
import com.pixelcheateon.ui.StyledButton;
import com.pixelcheateon.ui.Tag;
import com.pixelcheateon.ui.TargetHealthIndicator;
import com.pixelcheateon.ui.Toast;
import com.pixelcheateon.ui.Toolbar;
import com.pixelcheateon.ui.Window;
import com.pixelcheateon.utils.GLog;
import com.pixelcheateon.windows.WndBag;
import com.pixelcheateon.windows.WndGame;
import com.pixelcheateon.windows.WndHero;
import com.pixelcheateon.windows.WndInfoCell;
import com.pixelcheateon.windows.WndInfoItem;
import com.pixelcheateon.windows.WndInfoMob;
import com.pixelcheateon.windows.WndInfoPlant;
import com.pixelcheateon.windows.WndInfoTrap;
import com.pixelcheateon.windows.WndKeyBindings;
import com.pixelcheateon.windows.WndMessage;
import com.pixelcheateon.windows.WndOptions;
import com.pixelcheateon.windows.WndResurrect;
import com.pixelcheateon.windows.WndStory;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		if (Dungeon.hero == null || Dungeon.level == null){
			PixelCheateon.switchNoFade(TitleScene.class);
			return;
		}

		Dungeon.level.playLevelMusic();

		PCSettings.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + PCSettings.zoom(), maxZoom));
		Camera.main.edgeScroll.set(1);

		switch (PCSettings.cameraFollow()) {
		...
		int uiSize = PCSettings.interfaceSize();
		...
		status = new StatusPane( PCSettings.interfaceSize() > 0 );
		...
		if (PCSettings.intro()){
			...
			if (Document.ADVENTURERS_GUIDE.isPageFound(Document.GUIDE_INTRO)){
				...
				} else if (PCSettings.interfaceSize() == 0) {
	...
	public static void layoutTags() {
		...
		boolean tagsOnLeft = PCSettings.flipTags();
		float tagWidth = Tag.SIZE + (tagsOnLeft ? insets.left : insets.right);
		float tagLeft = tagsOnLeft ? 0 : uiCamera.width - tagWidth;

		float y = PCSettings.interfaceSize() == 0 ? scene.toolbar.top()-2 : scene.status.top()-2;
		if (PCSettings.interfaceSize() == 0){
			if (tagsOnLeft) {
		...
		if (tagsOnLeft && PCSettings.interfaceSize() > 0){
	...
	public static void gameOver() {
		...
		StyledButton restart = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(StartScene.class, "new"), 9){
			...
			protected void onClick() {
				...
				PixelCheateon.switchScene(HeroSelectScene.class);
			}
