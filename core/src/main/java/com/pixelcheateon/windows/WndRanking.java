...
import com.pixelcheateon.ui.BadgesGrid;
import com.pixelcheateon.ui.BadgesList;
import com.pixelcheateon.ui.CheckBox;
import com.pixelcheateon.ui.IconButton;
import com.pixelcheateon.ui.Icons;
import com.pixelcheateon.ui.ItemSlot;
import com.pixelcheateon.ui.RedButton;
import com.pixelcheateon.ui.RenderedTextBlock;
import com.pixelcheateon.ui.TalentButton;
import com.pixelcheateon.ui.TalentsPane;
		...
		public StatsTab() {
			...
			if (Dungeon.hero == null){
				...
				IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)) {
					...
					protected void onClick() {
						super.onClick();
						PixelCheateon.scene().addToFront(new WndScoreBreakdown());
					}
				};
			...
			if (Dungeon.hero != null && Dungeon.seed != -1 && !Dungeon.daily &&
				...
				RedButton btnSeed = new RedButton(Messages.get(this, "copy_seed")){
					...
					protected void onClick() {
						super.onClick();
						PixelCheateon.scene().addToFront(new WndOptions(new Image(icon),
							...
							protected void onSelect(int index) {
								...
								if (index == 0){
									PCSettings.customSeed(DungeonSeed.convertToCode(Dungeon.seed));
				...
				if (DungeonSeed.convertFromText(PCSettings.customSeed()) == Dungeon.seed){
					icon.hardlight(1f, 1.5f, 0.67f);
				}
				btnSeed.icon(icon);
