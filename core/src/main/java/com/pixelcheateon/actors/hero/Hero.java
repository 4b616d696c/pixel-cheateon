...
import com.pixelcheateon.Bones;
...
import com.pixelcheateon.actors.blobs.SacrificialFire;
import com.pixelcheateon.actors.buffs.AdrenalineSurge;
import com.pixelcheateon.actors.buffs.Amok;
import com.pixelcheateon.actors.buffs.AnkhInvulnerability;
...
import com.pixelcheateon.actors.buffs.Barkskin;
import com.pixelcheateon.actors.buffs.Barrier;
import com.pixelcheateon.actors.buffs.Berserk;
...
import com.pixelcheateon.actors.buffs.Combo;
import com.pixelcheateon.actors.buffs.Drowsy;
import com.pixelcheateon.actors.buffs.Foresight;
import com.pixelcheateon.actors.buffs.HoldFast;
import com.pixelcheateon.actors.buffs.Hunger;
import com.pixelcheateon.actors.buffs.Invisibility;
import com.pixelcheateon.actors.buffs.Levitation;
import com.pixelcheateon.actors.buffs.LostInventory;
import com.pixelcheateon.actors.buffs.MindVision;
import com.pixelcheateon.actors.buffs.Momentum;
import com.pixelcheateon.actors.buffs.MonkEnergy;
import com.pixelcheateon.actors.buffs.Paralysis;
import com.pixelcheateon.actors.buffs.PhysicalEmpower;
import com.pixelcheateon.actors.buffs.Recharging;
import com.pixelcheateon.actors.buffs.Regeneration;
import com.pixelcheateon.actors.buffs.SnipersMark;
...
import com.pixelcheateon.actors.mobs.Mimic;
import com.pixelcheateon.actors.mobs.Mob;
import com.pixelcheateon.actors.mobs.Monk;
import com.pixelcheateon.actors.mobs.Snake;
import com.pixelcheateon.effects.CellEmitter;
import com.pixelcheateon.effects.CheckedCell;
import com.pixelcheateon.effects.Speck;
import com.pixelcheateon.effects.SpellSprite;
import com.pixelcheateon.items.Amulet;
import com.pixelcheateon.items.Ankh;
import com.pixelcheateon.items.Dewdrop;
import com.pixelcheateon.items.EquipableItem;
import com.pixelcheateon.items.Heap;
import com.pixelcheateon.items.Heap.Type;
import com.pixelcheateon.items.Item;
import com.pixelcheateon.items.KindOfWeapon;
import com.pixelcheateon.items.armor.Armor;
import com.pixelcheateon.items.armor.ClassArmor;
import com.pixelcheateon.items.armor.glyphs.AntiMagic;
import com.pixelcheateon.items.armor.glyphs.Brimstone;
import com.pixelcheateon.items.armor.glyphs.Viscosity;
import com.pixelcheateon.items.artifacts.AlchemistsToolkit;
import com.pixelcheateon.items.artifacts.CapeOfThorns;
...
import com.pixelcheateon.items.bags.MagicalHolster;
import com.pixelcheateon.items.journal.Guidebook;
import com.pixelcheateon.items.keys.CrystalKey;
import com.pixelcheateon.items.keys.GoldenKey;
import com.pixelcheateon.items.keys.IronKey;
import com.pixelcheateon.items.keys.Key;
import com.pixelcheateon.items.keys.SkeletonKey;
...
import com.pixelcheateon.items.potions.elixirs.ElixirOfMight;
import com.pixelcheateon.items.potions.exotic.PotionOfDivineInspiration;
...
import com.pixelcheateon.items.scrolls.exotic.ScrollOfChallenge;
...
import com.pixelcheateon.journal.Notes;
import com.pixelcheateon.levels.Level;
import com.pixelcheateon.levels.Terrain;
import com.pixelcheateon.levels.features.Chasm;
import com.pixelcheateon.levels.features.LevelTransition;
import com.pixelcheateon.levels.traps.Trap;
import com.pixelcheateon.mechanics.ShadowCaster;
...
import com.pixelcheateon.scenes.SurfaceScene;
...
import com.pixelcheateon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			PixelCheateon.switchScene(AlchemyScene.class);
			return false;
		...
		if (rooted) {
			...
			if (transition.type == LevelTransition.Type.SURFACE){
				if (belongings.getItem( Amulet.class ) == null) {
					...
					&& Dungeon.initialVersion > PixelCheateon.v1_2_3
