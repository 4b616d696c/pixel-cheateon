...
package com.pixelcheateon.levels.painters;
...
import com.pixelcheateon.levels.Patch;
import com.pixelcheateon.levels.Terrain;
import com.pixelcheateon.levels.rooms.Room;
import com.pixelcheateon.levels.rooms.connection.ConnectionRoom;
			...
			for (Room n : r.connected.keySet()) {
				...
				if (d.type == Room.Door.Type.REGULAR){
					...
					if (r instanceof EntranceRoom || n instanceof EntranceRoom){
						if ((Dungeon.depth == 1 && PCSettings.intro())
