...
package com.pixelcheateon.journal.services.updates;

import com.pixelcheateon.PCSettings;
import com.pixelcheateon.services.updates.AvailableUpdateData;
import com.pixelcheateon.services.updates.UpdateService;
...
public class Updates {
	...
	public static void checkForUpdate(){
		...
		if (PCSettings.betas()){
			PCSettings.betas(true);
		}

		service.checkForUpdate(!PCSettings.WiFi(), PCSettings.betas(), new UpdateService.UpdateResultCallback() {
			@Override
