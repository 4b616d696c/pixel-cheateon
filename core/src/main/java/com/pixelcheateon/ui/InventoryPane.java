...
import com.pixelcheateon.items.bags.PotionBandolier;
import com.pixelcheateon.items.bags.ScrollHolder;
...
public class InventoryPane extends Component {
		...
		keyBlocker = new Signal.Listener<KeyEvent>(){
			...
			public boolean onSignal(KeyEvent keyEvent) {
				if (keyEvent.pressed && isSelecting() && InventoryPane.this.visible
						&& KeyBindings.getActionForKey(keyEvent) != PCAction.BAG_1
						&& KeyBindings.getActionForKey(keyEvent) != PCAction.BAG_2
						&& KeyBindings.getActionForKey(keyEvent) != PCAction.BAG_3
						&& KeyBindings.getActionForKey(keyEvent) != PCAction.BAG_4
						&& KeyBindings.getActionForKey(keyEvent) != PCAction.BAG_5){
					//any windows opened as a consequence of this should be centered on the inventory
					GameScene.centerNextWndOnInvPane();
					selector.onSelect(null);
					selector = null;
	...
	private class BagButton extends IconButton {
		...
		public GameAction keyAction() {
			switch (index){
				case 1: default:
					return PCAction.BAG_1;
				case 2:
					return PCAction.BAG_2;
				case 3:
					return PCAction.BAG_3;
				case 4:
					return PCAction.BAG_4;
				case 5:
					return PCAction.BAG_5;
			}
		}
