...
public class QuickSlotButton extends Button {
	...
	public GameAction keyAction() {
		switch (slotNum){
			case 0:
				return PCAction.QUICKSLOT_1;
			case 1:
				return PCAction.QUICKSLOT_2;
			case 2:
				return PCAction.QUICKSLOT_3;
			case 3:
				return PCAction.QUICKSLOT_4;
			case 4:
				return PCAction.QUICKSLOT_5;
			case 5:
				return PCAction.QUICKSLOT_6;
			default:
	...
	@Override
	public GameAction secondaryTooltipAction() {
		return PCAction.QUICKSLOT_SELECTOR;
	}
	...
	public static void set(int slotNum, Item item){
		...
		if (Statistics.duration + Actor.now() <= 10){
			...
			if (containsWaterskin) PCSettings.quickslotWaterskin(true);
		}
	}
	...
	public static void refresh() {
		...
		if (Statistics.duration + Actor.now() <= 10){
			...
			if (!containsWaterskin) PCSettings.quickslotWaterskin(false);
		}
	}
